...
public class DatabaseTest {
    ...
    @Before
    public void setUp(){
    	testedUser = new User("Luis", "10N20E", "LGracia@gmail.com", "Luis123", "100", "Person", 1);
    	...
    	testedUser2 = new User("Maria", "20N20E", "asd", "pass14753", "321", "Person", 1);
    ...
    public void testUpdateInfoAndAdaptation(){
    	 ...
    	 dat.updateInfo(user);
    	 User updatedUser = dat.getAgent("asd@gmail.com");
